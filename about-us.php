...
<body>
    ...
    <header>
        <div class="row">
            <div class="col-md-6">
                <div class="jumbotron">
                    <h1 class="display-4 text-dark">RENTIFY</h1>
                    <p class="lead">Rentify is a virtual renting platform that allows you to rent your electronics and
                        book rentals.</p>
                    <hr class="my-4">
                    <a class="btn btn-dark btn-lg" href="register/user" role="button">Get Started <i class="fas fa-angle-double-right"></i></a>
                </div>
            </div>
            <div class="col-md-6">
                <img class="img-fluid" src="img/undraw_co-workers_ujs6.svg">
            </div>
        </div>
    </header>
